...
@OnlyIn(Dist.CLIENT)
public class StarsilverGolemModel<T extends StarsilverGolemEntity> extends SegmentedModel<T> {
   ...
   public void prepareMobModel(T entityIn, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
